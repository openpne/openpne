 ...
 * and stay hidden by the renderer's route check until those features land. The group set is
 * seeded now and rendered once the group localNav context is wired.
 */
class NavigationSeeder extends Seeder
{
    ...
    private const ITEMS = [
        ...
        // :id threads into the query rather than the path.
