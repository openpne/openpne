 ...
 * default" (enabled, matching the OpenPNE 3 notification extension's absent member_config =
 * '1'). Channel is a row dimension, not two boolean columns, so the upgrade maps one source
 * member_config row (where present) to one row here.
 */
