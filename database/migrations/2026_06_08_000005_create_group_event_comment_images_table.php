 ...
 * Same shape as group_event_images: post_id -> the comment, file_id -> the stored bytes,
...
return new class extends Migration
{
    ...
    {
        Schema::create('group_event_comment_images', function (Blueprint $table) {
            $table->id();
            $table->foreignId('post_id')->constrained('group_event_comments')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('group_event_comment_images');
    }
};
