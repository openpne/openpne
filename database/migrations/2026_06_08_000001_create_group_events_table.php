 ...
 * area / deadline / capacity) that drive the RSVP model in group_event_members.
 */
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('group_events', function (Blueprint $table) {
            ...
            // Participant cap. Null = unlimited. Enforced at join time against group_event_members.
