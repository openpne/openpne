...
return new class extends Migration
{
    ...
    {
        Schema::create('group_event_images', function (Blueprint $table) {
            $table->id();
            $table->foreignId('post_id')->constrained('group_events')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('group_event_images');
    }
};
