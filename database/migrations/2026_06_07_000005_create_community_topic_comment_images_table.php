 ...
 * Same shape as community_topic_images: post_id -> the comment, file_id -> the stored bytes,
...
return new class extends Migration
{
    ...
    {
        Schema::create('community_topic_comment_images', function (Blueprint $table) {
            $table->id();
            $table->foreignId('post_id')->constrained('community_topic_comments')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('community_topic_comment_images');
    }
};
