 ...
 *
 *   direct_messages           <- SendMessageData (the sender's authored record)
 *   direct_message_recipients <- MessageSendList (+ DeletedMessage folded into per-side soft-delete cols)
 *
