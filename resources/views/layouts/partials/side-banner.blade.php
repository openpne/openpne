{{-- A global right-column gadget area on every Classic PC page (guests included).
     Resolved here in the shell, not per page; a guest sees only viewable-by-anyone kinds.
