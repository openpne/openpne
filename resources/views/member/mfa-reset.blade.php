...
@section('content')
    ...
    <div class="dparts form" id="member_config_mfa_reset">
        <div class="partsHeading"><h3>{{ __('Reset two-factor authentication') }}</h3></div>
        <div class="parts">
            <p>{{ __('Enter your account password to turn off two-factor authentication. You will then sign in with your password alone and can set it up again.') }}</p>
