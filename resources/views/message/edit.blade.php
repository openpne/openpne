...
@section('content')
    {{-- OpenPNE 3 re-renders the compose template for a draft (executeEdit setTemplate('sendToFriend')),
         so composing and re-editing share one parts id. --}}
    <x-classic.parts id="formMessage" name="form" :title="__('Edit draft')">
