...
<tr>
    ...
    <td>
        {{-- A native date input, kept on purpose; OpenPNE 3 drew a year input with month / day selects. --}}
...
<tr>
    <th><label for="event_open_date_comment">{{ __('Open date comment') }}</label></th>
    <td>
        <input type="text" class="input_text" id="event_open_date_comment" name="open_date_comment" value="{{ old('open_date_comment', $e?->open_date_comment) }}">
