    ...
    return (
        <input
            className={cn(
                ...
                // iOS Safari sizes a date field by its own UA rules, ignoring the author width — on
                // device the box runs past the viewport and scrolls the page sideways (Chromium is
                // unaffected either way). appearance-none puts the box back under this stylesheet;
                // the shadow value part is left-aligned to sit like every other input's text.
