    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger
                ...
                className={
                    compact
                        ? // The same 44px box as the bar's other edge controls (hamburger, back), so a
                          ...
                          '-mr-1 inline-flex size-11 shrink-0 items-center justify-center rounded-full outline-none focus-visible:ring-2 focus-visible:ring-ring'
