...
/**
 * Separate from PageHeading, so the heading stays h1 + action only. The crumbs are all ancestors —
 * the current page is not among them — so no `aria-current` (the WAI breadcrumb pattern).
 */
