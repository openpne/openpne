...
/**
 * Navigation rather than a primary action, so it sits below the page heading and never in the
 * heading's action slot. 44px tall to match the heading row, so switching tabs does not shift the
 * layout.
 */
