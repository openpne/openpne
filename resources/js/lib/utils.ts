...
// tailwind-merge dedupes only classes it can place in a group, so app.css's radius tokens and
// edge utilities are registered here; an unregistered pair such as `pt-safe-4 pt-4` would both
