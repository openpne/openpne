 ...
 * commented on (Related), or as a member of the content's group (Group — the broadcast). Each
 * maps to its own catalog kind, so a member can keep replies while muting the co-commenter or the
 * group-wide stream. One notification per recipient, precedence Reply > Related > Group: the
