...
/**
 * The tail of each row's thread, in one query for the whole page — `limit()` on an eager-loaded
 * HasMany compiles to a window-function partition (docs/internals/timeline.md, "Classic inline
 * replies"). Classic only: Modern's serializers carry a reply count, not the replies.
 */
class RecentReplies
{
