...
class HomeSerializer
{
     ...
     * @param  Collection<int, GroupTopic|CommunityEvent>  $groupActivity  joined-community activity
     ...
     */
    public static function activityEntry(GroupTopic|CommunityEvent $row): array
    {
        // The event board still names the relation `community`; the arms merge once it is renamed.
        $group = $row instanceof GroupTopic ? $row->group : $row->community;
