...
{
    /**
     * A browser hands out a fresh endpoint whenever its subscription is recreated, so an unbounded store
     * would grow with every reinstall. Public because it also multiplies the per-request push timeout
