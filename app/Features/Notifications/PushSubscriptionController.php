...
{
    /**
     * A browser hands out a fresh endpoint whenever its subscription is recreated and the store is
     * writable by anyone signed in, so an unbounded one would grow with every reinstall. Public
     * because a push job's budget is the per-request timeout times this cap
