...
class CreateEventComment
{
     ...
     */
    public function __invoke(Member $author, CommunityEvent $event, string $body): CommunityEventComment
    {
        ...
        return DB::transaction(function () use ($author, $event, $body): CommunityEventComment {
