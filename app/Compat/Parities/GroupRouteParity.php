    ...
    public function screens(): array
    {
        return [
            ...
            'edit' => [
                ...
                new ScreenElement('required-field markers', L::Three, S::Ported, "_partsForm.php mark_required_field + '%0% is required field.'", 'starred as OpenPNE 3 validated: name, description, register policy, the two topic authorities and the join mail; the category (nullable, checkCreatable passes empty) and the photo are not'),
            ],
