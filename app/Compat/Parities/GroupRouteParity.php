    ...
    public function screens(): array
    {
        return [
            ...
            'home' => [
                ...
                new ScreenElement('community timeline widget', L::Two, S::Ported, 'timeline/_timelineCommunity.php (opTimelinePlugin homeSuccess customize)', 'the same partial the standalone page renders, injected before this box and shown to members only (isPrivilegeBelong); five rows rather than OpenPNE 3\'s twenty, which it streamed behind a load-more'),
