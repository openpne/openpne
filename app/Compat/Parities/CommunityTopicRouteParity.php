...
class CommunityTopicRouteParity extends RouteParity
{
     ...
     * resources/views/community-topic/*.blade.php. Levels follow
     * docs/internals/classic-compatibility.md; an item short of a faithful port records why.
     */
    public function screens(): array
    {
        return [
            // listCommunitySuccess.php → community-topic/index.blade.php
            'listCommunity' => [
            ...
            // showSuccess.php + communityTopicComment/_list.php → community-topic/show.blade.php.
            ...
            // newSuccess.php (PluginCommunityTopicForm) → community-topic/new.blade.php
            'new' => [
            ...
            // editSuccess.php (same form as new) → community-topic/edit.blade.php
            'edit' => [
                new ScreenElement('title input', L::Two, S::Ported, 'PluginCommunityTopicForm name sfWidgetFormInput'),
                new ScreenElement('body textarea', L::Two, S::Ported, 'BaseCommunityTopicForm body', 'OpenPNE 4 adds the shared body-format toggle'),
            ...
            // deleteConfirmSuccess.php → community-topic/delete.blade.php
            'deleteConfirm' => [
