    ...
    public function screens(): array
    {
        return [
            ...
            'list' => [
                ...
                new ScreenElement('title + comment count', L::Two, S::Ported, 'op_diary_get_title_and_count', 'withCount(comments) appended as "(N)"'),
            ...
            'listFriend' => [
                ...
                new ScreenElement('empty-state message', L::Three, S::Ported, 'op_include_box diaryList'),
                new ScreenElement('per-entry title + comment count', L::Two, S::Ported, 'op_diary_get_title_and_count', 'withCount(comments) appended as "(N)"'),
                new ScreenElement('has-images icon', L::Three, S::Missing, 'op_diary_image_icon', 'image delivery not built'),
            ],
            ...
            'listMember' => [
                ...
                new ScreenElement('per-entry title + comment count', L::Two, S::Ported, 'op_diary_link_to_show', 'withCount(comments) appended as "(N)"'),
                new ScreenElement('LayoutB two-column + sidemenu (author, recent diaries)', L::Two, S::Ported, "decorate_with('layoutB') + get_component('diary','sidemenu')", 'x-diary.sidemenu; member avatar deferred (FileStorage)'),
