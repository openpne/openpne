...
class CommunityRouteParity extends RouteParity
{
    ...
    public function screens(): array
    {
        return [
            ...
            'home' => [
                new ScreenElement('community image box (photo + name)', L::Two, S::Partial, "op_include_parts('memberImageBox', 'communityImageBox')", 'x-community.sidemenu; 180×180 thumbnail and the getNameAndCount() caption, but OpenPNE 4 links the photo to the full-size image where OpenPNE 3 rendered it bare'),
