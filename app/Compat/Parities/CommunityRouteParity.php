    ...
    public function screens(): array
    {
        return [
            ...
            'edit' => [
                ...
                new ScreenElement('topic read authority (public_flag)', L::Two, S::Missing, 'opCommunityTopicPlugin community_config.yml public_flag', 'not editable in OpenPNE 4; the community home shows the stored value read-only'),
                new ScreenElement('topic create authority (topic_authority)', L::Two, S::Missing, 'opCommunityTopicPlugin community_config.yml topic_authority', 'not editable in OpenPNE 4; the community home shows the stored value read-only'),
