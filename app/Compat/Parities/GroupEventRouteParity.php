    ...
    public function screens(): array
    {
        return [
            ...
            'communityEventComment/deleteConfirm' => [
                ...
                new ScreenElement('box heading (the question)', L::Three, S::Partial, "deleteConfirmSuccess.php title => __('Do you really delete this comment?')", 'headed "Delete the comment", with the question moved into a paragraph inside the box'),
