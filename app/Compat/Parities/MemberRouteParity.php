    ...
    public function screens(): array
    {
        return [
            ...
            'config' => [
                ...
                new ScreenElement('profile page public flag', L::Two, S::Ported, 'member_config.yml publicFlag.profile_page_public_flag (All Users on the Web / All Members) under sns_config is_allow_config_public_flag_profile_page', 'members.profile_visibility, a Members / Open select offered only while SnsSettingKey::ProfileVisibilityPolicy is member_choice — the same admin gate OpenPNE 3 unset the field under'),
