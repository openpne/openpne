    ...
    public function screens(): array
    {
        return [
            ...
            'config' => [
                ...
                new ScreenElement('profile page public flag', L::Two, S::Missing, 'member_config.yml publicFlag.profile_page_public_flag (All Users on the Web / All Members)', 'members.profile_visibility is read-only in the app — only the upgrade writes it — so a member cannot change who reaches their profile page'),
