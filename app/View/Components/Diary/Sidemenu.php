...
/**
 * OpenPNE 3 diary sidemenu (get_component('diary','sidemenu')). Everything is scoped to the current
 * viewer: a guest on a web-public page sees only web-public entries.
 */
