 ...
 */
class GroupEventPluginFeatureUpgrade extends FeatureFlagUpgrade
{
    ...
    {
        return Column::expr(sprintf("'%s'", Feature::GroupEvent->settingKey()->value));
    }

    protected function featureKeys(): array
    {
        return [Feature::GroupEvent->settingKey()];
    }
}
