 ...
 * the not-installed plugin tables to create empty so their steps no-op; unknownConfigNames are
 * reported and migrated past.
 */
final class SourcePreflightReport
{
     ...
     * @param  array<string, array<string, int>>  $unknownConfigNames  KV table => unrecognised name => rows
     */
    public function __construct(
        public readonly array $tableErrors,
        public readonly array $columnErrors,
        public readonly array $absentOptional,
        public readonly array $unknownConfigNames = [],
    ) {}
