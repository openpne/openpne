...
// The single image attached to a timeline post, pointing at a stored File. A join row only —
// no timestamps; the bytes and their timestamps belong to the File, which cascades this row
// away when deleted.
