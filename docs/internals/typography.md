...
visual rank. A dialog title is a Radix primitive that takes the component through `asChild`: a class
built by a call is not one the lint reads (`shadcn/require-static-classes`).
