...
class GadgetSeederTest extends TestCase
{
    ...
    public function test_seeds_the_openpne3_default_pc_set(): void
    {
        ...
        $this->assertDatabaseHas('gadgets', ['context' => 'home', 'zone' => 'top', 'name' => 'birthdayBox']);
        $this->assertDatabaseHas('gadgets', ['context' => 'profile', 'zone' => 'top', 'name' => 'birthdayBox']);
        ...
        $this->assertDatabaseHas('gadgets', ['context' => 'home', 'zone' => 'contents', 'name' => 'recentGroupEventComment']);
