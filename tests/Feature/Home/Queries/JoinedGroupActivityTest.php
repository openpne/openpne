...
class JoinedGroupActivityTest extends TestCase
{
    ...
    public function test_merges_topics_and_events_newest_first(): void
    {
        ...
        $topic = CommunityTopic::factory()->create(['community_id' => $group->getKey(), 'updated_at' => now()->subHour()]);
    ...
    public function test_keeps_a_topic_and_an_event_that_share_a_numeric_id(): void
    {
        ...
        $topic = CommunityTopic::factory()->create(['id' => 4242, 'community_id' => $group->getKey()]);
    ...
    public function test_ties_on_updated_at_place_topics_before_events(): void
    {
        ...
        CommunityTopic::factory()->create(['community_id' => $group->getKey(), 'updated_at' => $at]);
    ...
    public function test_eager_loads_the_community_image_on_every_row(): void
    {
        ...
        CommunityTopic::factory()->create(['community_id' => $group->getKey(), 'updated_at' => now()->subHour()]);
    ...
    public function test_caps_at_the_limit_across_both_sources(): void
    {
        ...
        CommunityTopic::factory()->count(4)->create(['community_id' => $group->getKey()]);
