...
class DirectMessageControllerTest extends TestCase
{
    ...
    public function test_inbox_renders_with_the_sender_and_subject(): void
    {
        ...
        $response->assertSee(route('message.receive.show', ['message' => DirectMessage::first()->getKey()]), false);
    }
    ...
    public function test_draft_list_links_the_subject_to_the_edit_form(): void
    {
        ...
        $editUrl = route('message.draft.edit', ['message' => DirectMessage::firstOrFail()->getKey()]);
