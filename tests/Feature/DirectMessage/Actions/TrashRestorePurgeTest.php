...
class TrashRestorePurgeTest extends TestCase
{
    ...
    private function delivered(Member $sender, Member $recipient): array
    {
        ...
        $receipt = DirectMessageRecipient::factory()->create([
    ...
    public function test_trash_moves_only_the_acting_side(): void
    {
        ...
        $this->assertSame(1, app(TrashDirectMessages::class)($recipient, DirectMessageBox::Receive, [$message->getKey()]));
    ...
    public function test_trashing_a_sent_message_sets_the_sender_side(): void
    {
        ...
        $this->assertSame(1, app(TrashDirectMessages::class)($sender, DirectMessageBox::Sent, [$message->getKey()]));
    ...
    public function test_trash_is_idempotent_and_keeps_the_first_moved_time(): void
    {
        ...
        app(TrashDirectMessages::class)($recipient, DirectMessageBox::Receive, [$message->getKey()]);
        ...
        $this->assertSame(0, app(TrashDirectMessages::class)($recipient, DirectMessageBox::Receive, [$message->getKey()]));
    ...
    public function test_actions_are_scoped_to_the_viewer(): void
    {
        ...
        $this->assertSame(0, app(TrashDirectMessages::class)($stranger, DirectMessageBox::Receive, [$message->getKey()]));
        $this->assertSame(0, app(RestoreDirectMessages::class)($stranger, [$message->getKey()]));
        $this->assertSame(0, app(PurgeDirectMessages::class)($stranger, [$message->getKey()]));
    }
    ...
    public function test_restore_clears_only_the_acting_side(): void
    {
        ...
        $this->assertSame(1, app(RestoreDirectMessages::class)($recipient, [$message->getKey()]));
    ...
    public function test_restore_does_not_revive_a_purged_side(): void
    {
        ...
        $this->assertSame(0, app(RestoreDirectMessages::class)($recipient, [$message->getKey()]));
    ...
    public function test_purge_only_applies_to_a_trashed_row_and_keeps_purged_implies_deleted(): void
    {
        ...
        $this->assertSame(0, app(PurgeDirectMessages::class)($recipient, [$message->getKey()]));
        $this->assertNull($receipt->fresh()->recipient_purged_at);

        $receipt->forceFill(['recipient_deleted_at' => now()])->save();
        $this->assertSame(1, app(PurgeDirectMessages::class)($recipient, [$message->getKey()]));
    ...
    public function test_purge_is_per_side_and_keeps_the_row_and_counterpart_copy(): void
    {
        ...
        app(PurgeDirectMessages::class)($sender, [$message->getKey()]);
        ...
        $this->assertDatabaseHas('direct_messages', ['id' => $message->getKey()]);
        $this->assertDatabaseHas('direct_message_recipients', ['id' => $receipt->getKey()]);
    }
    ...
    public function test_bulk_covers_many_ids_at_once(): void
    {
        ...
        $this->assertSame(2, app(TrashDirectMessages::class)($recipient, DirectMessageBox::Receive, [$a->getKey(), $b->getKey()]));
    }
}
