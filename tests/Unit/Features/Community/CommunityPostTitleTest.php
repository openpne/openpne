...
namespace Tests\Unit\Features\Community;
...
class CommunityPostTitleTest extends TestCase
{
    public function test_short_name_keeps_its_text_and_appends_the_count_with_no_space(): void
    {
        $this->assertSame('Hello(3)', CommunityPostTitle::withCount($this->topic('Hello', 3)));
    }
    ...
    public function test_missing_count_renders_as_zero(): void
    {
        ...
        $this->assertSame('No count loaded(0)', CommunityPostTitle::withCount($topic));
    }

    public function test_long_ascii_name_is_truncated_to_36_without_an_ellipsis(): void
    {
        $label = CommunityPostTitle::withCount($this->topic(str_repeat('a', 50), 0));
    ...
    public function test_full_width_name_is_truncated_by_display_width(): void
    {
        ...
        $label = CommunityPostTitle::withCount($this->topic(str_repeat('あ', 20), 1));
    ...
    public function test_accepts_an_event(): void
    {
        ...
        $this->assertSame('Meetup(2)', CommunityPostTitle::withCount($event));
    }
